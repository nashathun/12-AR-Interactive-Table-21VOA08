...
registerOnClick('Cone', false, false, [0,1,2], function() {
  assignMat('Cube.008', 'CHROME.2');
}, function() {});

registerOnClick('Cone', false, false, [0,1,2], function() {
  assignMat('Cube.002', 'CHROME.2');
}, function() {});

registerOnClick('Cone.001', false, false, [0,1,2], function() {
  assignMat('Cube.008', 'CHROME');
}, function() {});

registerOnClick('Cone.001', false, false, [0,1,2], function() {
  assignMat('Cube.002', 'CHROME');
}, function() {});

registerOnClick('Cone.002', false, false, [0,1,2], function() {
  assignMat('Cube.008', 'CHROME.3');
}, function() {});

registerOnClick('Cone.002', false, false, [0,1,2], function() {
  assignMat('Cube.002', 'CHROME.3');
}, function() {});

registerOnClick('Cube.004', false, false, [0,1,2], function() {
  replaceTexture('wood_00', 'wood', './wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('Cube.005', false, false, [0,1,2], function() {
  replaceTexture('wood_00', 'wood', './wood_basecolor_3.jpg', function() {});
}, function() {});

registerOnClick('Cube.006', false, false, [0,1,2], function() {
  replaceTexture('wood_00', 'wood', './wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('Cube.003', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'Cube.003', null, null, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'Cube.003', 1, 30, 'LoopOnce', 1,
            function() {
      status2 = 'closed';
    }, true);
...
registerOnClick('Cube.003', false, false, [0,1,2], function() {
  if (status2 == 'closed') {
    ...
    operateAnimation('PLAY', 'Cube.002', null, null, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'Cube.002', 1, 30, 'LoopOnce', 1,
            function() {
      status2 = 'closed';
    }, true);
